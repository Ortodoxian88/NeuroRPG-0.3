...
export default function App() {
  ...
  if (!user) {
    return (
      <div className="h-[100dvh] bg-black flex flex-col items-center justify-between p-8 text-neutral-100 overflow-hidden">
        <div className="flex-1 flex flex-col items-center justify-center w-full space-y-8 text-center">
          <div className="space-y-2">
            <div className="w-20 h-20 bg-orange-600 rounded-3xl mx-auto flex items-center justify-center shadow-2xl shadow-orange-600/20 rotate-3">
              <span className="text-4xl font-black text-white">N</span>
            </div>
            <h1 className="text-4xl font-bold tracking-tighter text-white font-display pt-4">NeuroRPG</h1>
            <p className="text-neutral-500 text-sm font-medium">Твой персональный ИИ Гейм-мастер</p>
          </div>
        ...
        <div className="w-full max-w-xs grid grid-cols-2 gap-3 pb-4">
          <button 
